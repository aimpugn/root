...
public class AdminController {
	...
	public void showState(String admin_status_flag, HttpServletRequest request, HttpServletResponse response) {
		String msg = "-1";
		System.out.println("상태검색 들어오나"+admin_status_flag);
		try {
			List<Admin> adminList = dao.selectByState(admin_status_flag);
			System.out.println("상태검색 리스트" + adminList);
			String forwardURL = "/admin/member/admin.jsp";
			request.setAttribute("adminList", adminList);
			RequestDispatcher dispatcher = request.getRequestDispatcher(forwardURL);
			msg = "1";
