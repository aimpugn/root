...
public class AdminUser {
	...
	public int getUser_gender_count() {
		return user_gender_count;
	}
	public void setUser_gender_count(int user_gender_count) {
		this.user_gender_count = user_gender_count;
	}	
	@Override
	public String toString() {
		return "User [user_id=" + user_id + ", user_password=" + user_password + ", user_nick_name=" + user_nick_name
				...
				+ user_push_token + ", user_friend_count=" + user_friend_count + ", user_gender_count=" + user_gender_count + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
